# idioms is an dictionary with multiple key/value pairs
...
# loop through idioms and return the keys and values
for word, sentence in idioms.items():
    # word and sentence are place holders/taco .join takes all items in
    # an iterable and joins them into a string
    print(f'{word}: {" ".join(sentence)}')